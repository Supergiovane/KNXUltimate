...
export const KNXIP_HDR_TUNNELING_CONNECT_REQUEST = Buffer.from('06100205', 'hex');
export const KNXIP_HDR_SECURE_SESSION_REQUEST = Buffer.from('06100951', 'hex');
export const KNXIP_HDR_SECURE_SESSION_AUTHENTICATE = Buffer.from('06100953', 'hex');
export const TUNNELING_ACK_TOTAL_LEN = 0x000A;

// Data Secure counter suffix (seq + addr + suffix)
export const DATA_SECURE_CTR_SUFFIX = Buffer.from([0x00, 0x00, 0x00, 0x00, 0x01, 0x00]);

// Session authenticate CTR IV suffix for MAC transformation
export const AUTH_CTR_IV = Buffer.from('0000000000000000000000000000ff00', 'hex');
...
export const DEFAULT_KNXKEYS_PATH = '/Users/massimosaccani/Documents/GitHub/KNXUltimate/documents/Secure Test.knxkeys';
export const DEFAULT_KNXKEYS_PASSWORD = 'passwordprogetto';

// HPAI/CRD for connect request
export const HPAI_CONTROL_ENDPOINT_EMPTY = Buffer.from('0802000000000000', 'hex');
